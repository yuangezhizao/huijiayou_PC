...
/*默认品牌特惠图片*/
var g_brand_Pic = "https://image-mall.huijiayou.cn/hjyweb/img/bg_jyh.jpg";
var g_brand_logo_Pic = "https://image-mall.huijiayou.cn/hjyweb/img/hh.jpg";
/*默认头像图片*/
var g_head_pic = "https://image-mall.huijiayou.cn/hjyweb/img/mrtx.jpg";
//默认评论图片
var g_comment_pic = "https://image-mall.huijiayou.cn/hjyweb/img/hh.jpg";
//默认评论大图
var g_comment_big_pic = "https://image-mall.huijiayou.cn/hjyweb/img/bg_jyh.jpg";
/*栏目类型*/
...
var g_const_orderStatus = {
    ...
    GetPacketStatusText: function (orderStatus) {
        switch (orderStatus) {
            case g_const_orderStatus.DFK:
                return "等待支付";
            case g_const_orderStatus.DFH:
...
var g_const_PageURL = {
    ...
    /*公告列表*/
    "NoticeList": "/Notice/list.html",
    /*公告详情*/
    "NoticeDetail": "/Notice/detail.html",
    ...
    /*商品列表*/
    "Product_List": "/Search/SearchList.html",
    ...
    /*充值订单支付页*/
    "OrderPay_MobileCHZ": "/order/MobileCHZ_OrderPay.html",
    ...
    /*手机充值结果页*/
    "MobileCZResult": "/MobileCZ/OrderResult.html",
    ...
    /*供应商信息*/
    "SellerInfo": "/Product/SellerInfo.html",
    ...
    GoByMainIndex: function (PageURL, p, isreplace, isOpen) {
        ...
        if (p != null && p != "")
            url += p;
        if (isOpen || PageURL == "ProductDetail" || PageURL == "SearchList" || PageURL == "Cart" || PageURL == "MyCoupon" || PageURL == "MyCollection") {
            var openLink = $("#com_a");
...
/*订单渠道ID*/
var g_const_ChannelID = "449747430004";
//是否分享
...
var g_const_ProductLabel = {
    //生鲜
    Fresh: { name: "生鲜商品", value: "LB160108100002", picture: cdn_path + "/img/xxh_txbtn.png", spicture: cdn_path + "/img/icon_msg_fresh.png", productdetailpic: cdn_path + "/img/xxh_txbtn.png" },
    //TV商品
    TV: { name: "TV商品", value: "LB160108100003", picture: "", spicture: "", productdetailpic: "" },
    //海外购商品
    OverSea: { name: "海外购商品", value: "LB160108100004", picture: cdn_path + "/img/hwg_txbtn.png", spicture: cdn_path + "/img/icon_msg_haiwaigou.png", productdetailpic: cdn_path + "/img/plane_bg.png" },
    //查找
    ...
    GetLabelHtml: function (labelsList, flagTheSea) {
        if (labelsList && labelsList.length > 0) {
            ...
            if (label && label.spicture.length > 0) {
