...
function ConfirmMessage(sMessage, callBackFail, callBackSuccess) {
...
var web_fromparam_duomai = web_from + "|" + GetQueryString("feedback") + "|" + GetQueryString("mid") + "|" + GetQueryString("to");
        ...
        try {
            if (localStorage[g_const_localStorage.OrderFrom] != "" && localStorage[g_const_localStorage.OrderFromRefer]!="") {
                if (localStorage[g_const_localStorage.OrderFrom] == Merchant_duomai.Code) {
                    ...
                    //获得euid
                    var referer = localStorage[g_const_localStorage.OrderFromRefer];
