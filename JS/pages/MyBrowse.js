...
var Product = {
    ...
    GetList: function () {
        ...
        request.done(function (msg) {
            ...
            if (msg.resultCode == g_const_Success_Code) {
                ...
                Product.Load_Result(msg.getBrowseHistory);
    ...
    Load_Result: function (resultlist) {
        ...
        $.each(resultlist, function (i, n) {
            ...
            bodyList += "<img src=\"" + g_GetPictrue(n.mainpicUrl) + "\" width=\"90\" height=\"90\">";
            bodyList += "<p></p>";//<em>赠品</em>
            bodyList += "<b>" + n.productName + "</b>";
            bodyList += "</a>";
            bodyList += "</td>";
            bodyList += "<td>￥" + n.sellPrice + "</td>";
            bodyList += "<td><a style=\"cursor:pointer\" onclick=\"Product.Load_Product('" + n.productCode + "')\">查看商品详情</a><a  style=\"cursor:pointer\" onclick=\"CollectionDelete('" + n.productCode + "')\">取消关注</a></td>";
            bodyList += "</tr>";
        });
